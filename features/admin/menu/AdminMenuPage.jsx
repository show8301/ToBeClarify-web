...
const MENU_IMAGE_CROP = Object.freeze({
  width: 1200,
  height: 900,
  aspect: 4 / 3,
  title: '調整餐點圖片',
  description: '拖曳圖片決定餐點主體位置，使用縮放滑桿調整大小；輸出固定為 1200 × 900px WebP。',
  hint: '裁切比例為 4:3，適用於前台菜單與顧客點餐卡片。',
});
const MENU_IMAGE_OUTPUT = Object.freeze({
  fileType: 'image/webp',
  quality: 0.9,
  maxSizeMB: 1.2,
