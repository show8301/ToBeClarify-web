  ...
  return <div className="home-page">
    ...
    <section className="home-hero">
      ...
      <motion.div className="home-hero-copy" initial={reduceMotion?false:{opacity:0,y:28,filter:"blur(8px)"}} animate={{opacity:1,y:0,filter:"blur(0px)"}} transition={{delay:reduceMotion ? 0 : .72,duration:reduceMotion ? .2 : 1.15,ease:[.22,1,.36,1]}}>
        ...
        {home.pageVisibility.staff&&<a href="/staff">MEET THE DREAMERS <i>↗</i></a>}
      </motion.div>
    ...
    <section className="home-final-cta"><span>READY TO ENTER?</span><h2>今晚，想遇見<br/>哪一場夢？</h2><div>{home.pageVisibility.staff&&<a href="/staff">店員一覽 <i>↗</i></a>}{home.pageVisibility.menu&&<a href="/menu">佳餚名錄 <i>↗</i></a>}</div></section>
  </div>;
}
